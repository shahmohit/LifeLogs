...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        mMaxValue = attrs.getAttributeIntValue(ANDROIDNS, "max", 10);
        mMinValue = attrs.getAttributeIntValue(ANDROIDNS, "min", 0);

        mUnitsLeft = getAttributeStringValue(attrs, ANDROIDNS, "unitsLeft", "1 min");
        String units = getAttributeStringValue(attrs, ANDROIDNS, "units", "");
        mUnitsRight = getAttributeStringValue(attrs, ANDROIDNS, "unitsRight", "1 day");
    ...
    protected void updateView(View view) {
        ...
        try {
            ...
            mStatusText.setText(Constants.Intervals[mCurrentValue]);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (newValue > mMaxValue)
            newValue = Math.round(mMaxValue);
        else if (newValue < mMinValue)
            newValue = Math.round(mMinValue);
        ...
        mStatusText.setText(Constants.Intervals[newValue]);
        persistInt(newValue);
